...
def proportional_control():
    global Q_weight, red_twist, accumulated_error, previous_angle, previous_center, blue_center, X_k1, P_k1, R_k, rp_rate
    ...
    red_twist = yaw_vel_to_twist(direction, speed)
...
def simple_agent():
    ...
    sub_blue_center = rospy.Subscriber('/red_sphero/center', Point, set_center, queue_size=1)
    sub_blue_flag = rospy.Subscriber('/red_sphero/flag', Bool, set_flag, queue_size=1)
    sub_blue_base = rospy.Subscriber('/red_sphero/base', Point, set_blue_base, queue_size=1)
    sub_red_base = rospy.Subscriber('/blue_sphero/base', Point, set_red_base, queue_size=1)
